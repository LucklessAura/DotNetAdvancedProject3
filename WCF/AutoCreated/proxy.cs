...
public interface interfaceClasses
{
    ...
    byte[] GetImageBytes(Project1.File file);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/interfaceClasses/GetImageBytes", ReplyAction="http://tempuri.org/interfaceClasses/GetImageBytesResponse")]
    System.Threading.Tasks.Task<byte[]> GetImageBytesAsync(Project1.File file);
}
...
public partial class interfaceClassesClient : System.ServiceModel.ClientBase<interfaceClasses>, interfaceClasses
{
    ...
    public byte[] GetImageBytes(Project1.File file)
    {
        return base.Channel.GetImageBytes(file);
    }
    
    public System.Threading.Tasks.Task<byte[]> GetImageBytesAsync(Project1.File file)
    {
        return base.Channel.GetImageBytesAsync(file);
    }
}
